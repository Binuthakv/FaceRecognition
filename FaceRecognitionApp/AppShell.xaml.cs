...
public partial class AppShell : Shell
{
    ...
    private void LoadAdminInfo()
    {
        try
        {
            ...
            {
                // FlyoutHeader is a separate DataTemplate scope — x:Name fields are not
                // generated for it in the partial class. Use FindByName at runtime instead.
                var label = this.FindByName<Label>("AdminNameLabel");
                if (label != null)
